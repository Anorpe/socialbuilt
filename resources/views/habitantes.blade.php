...
<head>
    ...
    <title>{{ config('app.name', 'Social Built') }}</title>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <table class="table">
                                <thead>
                                <tr>
                                    <th scope="col"><div class="card-header">{{ __('Habitantes') }}</div></th>
                                    <th scope="col"><div class="card-header">{{ __('Noticias') }}</div></th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
